...
class TorchMD_ET(BaseModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # print("rbf_type:", rbf_type)
        # print("trainable_rbf:", trainable_rbf)
        # print("activation:", activation)
        # print("attn_activation:", attn_activation)
        # print("neighbor_embedding:", neighbor_embedding)
        # print("num_heads:", num_heads)
        # print("distance_influence:", distance_influence)
        # print("max_z:", max_z)
        # print("max_num_neighbors:", max_num_neighbors)
        # print("num_post_layers:", num_post_layers)
        # print("post_hidden_channels:", post_hidden_channels)
        # print("pool:", pool)
        # print("aggr:", aggr)
        # print("kwargs:", kwargs)
        ...
        # print all the parameters that are given to initialize the model
