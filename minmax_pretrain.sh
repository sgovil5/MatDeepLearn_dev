...
#SBATCH -J pretrain_linspace1_orders8_sigmas6_minmax  # Job name
...
#SBATCH -o featurizer_results/pretrain/linspace1_orders8_sigmas6_minmax.out               # Combined output and error messages file
#SBATCH --mail-type=BEGIN,END,FAIL           # Mail preferences
#SBATCH --mail-user=sgovil9@gatech.edu           # e-mail address for notifications

export DATASET_SRC_FILE=linspace1_orders8_sigmas6_minmax
sed -i "s/DATASET_SRC_FILE/$DATASET_SRC_FILE/" configs/GMP_pretraining.yml
module load anaconda3
conda activate my_mdl_env
echo pretrain_linspace1_orders8_sigmas6_minmax
