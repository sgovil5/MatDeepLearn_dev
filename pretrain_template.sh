...
#SBATCH -J pretrain_linspace${linspace}_orders${orders}_sigmas${sigmas}${scale}  # Job name
...
#SBATCH -o featurizer_results/pretrain/linspace${linspace}_orders${orders}_sigmas${sigmas}${scale}.out               # Combined output and error messages file
...
echo pretrain_linspace${linspace}_orders${orders}_sigmas${sigmas}${scale}
